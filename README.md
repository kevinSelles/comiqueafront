...
- **Cierre de sesión**
  Se mantiene el botón de cierre de sesión en el menú de perfil del usuario, pero ahora además se añade la opción de cierre de sesión en el propio header para que sea más accesible.
